...
execute if entity @e[type=player,distance=..1.5,team=blue,tag=!frozen] run tag @s add hit
...
execute as @s[tag=!hit,tag=!hitBlock,scores={steps=1..}] at @s run function cf:rayred/move
