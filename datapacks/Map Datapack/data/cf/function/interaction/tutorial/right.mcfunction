...
scoreboard players add .tutorial tutorial 1

execute if score .tutorial tutorial matches 10.. run scoreboard players set .tutorial tutorial 1
...
item replace entity @e[tag=tutorialright,type=item_display] container.0 with paper[custom_model_data=2004]
